                ...
                if(!user.isEmailVerified())
                {
                    user.sendEmailVerification().addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(VerificationScreen.this, "A Verification Email Has Been Sent To Your Email Address.", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(VerificationScreen.this, ManagementLoginForm.class);
